...
export declare const AZURE_CONTAINER_APP_INSTANCE_ID = "azure.container_app.instance.id";
export declare const AZURE_CONTAINER_APP_NAME = "azure.container_app.name";
export declare const AZURE_CONTAINER_APP_VERSION = "azure.container_app.version";
export declare const CONTAINER_APP_NAME = "CONTAINER_APP_NAME";
export declare const CONTAINER_APP_REVISION = "CONTAINER_APP_REVISION";
export declare const CONTAINER_APP_HOSTNAME = "CONTAINER_APP_HOSTNAME";
export declare const CONTAINER_APP_ENV_DNS_SUFFIX = "CONTAINER_APP_ENV_DNS_SUFFIX";
export declare const CONTAINER_APP_REPLICA_NAME = "CONTAINER_APP_REPLICA_NAME";
export declare const CONTAINER_APP_PORT = "CONTAINER_APP_PORT";
