    ...
    async _storeToDisk(payload, envelopes) {
        ...
        try {
            ...
            if (size > this.maxBytesOnDisk) {
                ...
                this._customerSDKStatsMetrics?.countDroppedItems(envelopes, DropCode.CLIENT_PERSISTENCE_CAPACITY);
        ...
        try {
            ...
            this._customerSDKStatsMetrics?.countDroppedItems(envelopes, DropCode.CLIENT_EXCEPTION, writeError?.message, ExceptionType.STORAGE_EXCEPTION);
 ...
 * @internal
 */
export function getStorageDirectory(instrumentationKey, storageDirectory) {
    let userSegment;
    let processName;
