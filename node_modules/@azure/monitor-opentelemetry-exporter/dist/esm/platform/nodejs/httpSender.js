...
export class HttpSender extends BaseSender {
    ...
    constructor(options) {
        ...
        else if (!this.appInsightsClientOptions.credentials?.scopes &&
    ...
    createClient(clientOptions) {
        ...
        const client = new ApplicationInsightsClient(this.credential, clientOptions);
