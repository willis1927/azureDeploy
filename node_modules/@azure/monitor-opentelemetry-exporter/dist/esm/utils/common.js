...
import { experimentalOpenTelemetryValues, MaxPropertyLengths } from "../types.js";
import { getInstance } from "../platform/index.js";
import { KnownContextTagKeys } from "../generated/index.js";
import { diag } from "@opentelemetry/api";
import { hrTimeToNanoseconds } from "@opentelemetry/core";
import { APPLICATION_ID_RESOURCE_KEY, CUSTOM_DIMENSIONS_GENAI_KEYS, ENV_OPENTELEMETRY_RESOURCE_METRIC_DISABLED, isEnvVarTrue, } from "../Declarations/Constants.js";
...
export function createResourceMetricEnvelope(resource, instrumentationKey, applicationId) {
    const attributes = resource.attributes;
    if (attributes) {
 ...
 * @internal
 */
export function truncateCustomDimensions(properties) {
    const defaultMaxSize = MaxPropertyLengths.THIRTEEN_BIT;
    const genaiMaxSize = MaxPropertyLengths.EIGHTEEN_BIT;
    const result = {};
    let truncated = false;
    for (const key of Object.keys(properties)) {
        let value = typeof properties[key] === "string"
            ? properties[key]
            : serializeAttribute(properties[key]);
