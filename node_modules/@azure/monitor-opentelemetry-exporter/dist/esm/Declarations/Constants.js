 ...
 * @internal
 */
export function isEnvVarTrue(envVarName) {
 ...
 * @internal
 */
export const ENV_APPLICATIONINSIGHTS_SDKSTATS_EXPORT_INTERVAL = "APPLICATIONINSIGHTS_SDKSTATS_EXPORT_INTERVAL";
/**
 ...
 * @internal
 */
export const CUSTOM_DIMENSIONS_GENAI_KEYS = new Set([
