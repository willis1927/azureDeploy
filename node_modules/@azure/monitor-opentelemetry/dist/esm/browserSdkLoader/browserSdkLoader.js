...
export class BrowserSdkLoader {
    ...
    constructor(config) {
        ...
        if (config.browserSdkLoaderOptions?.connectionString) {
            clientWebIkey = this._getBrowserSdkLoaderIkey(config?.browserSdkLoaderOptions?.connectionString);
        }
                        ...
                        try {
                            if (isGetRequest) {
                                ...
                                if (headers === null || headers === undefined) {
                                    ...
                                    // eslint-disable-next-line prefer-rest-params
                                    arguments[0] = BrowserSdkLoader._instance?.InjectSdkLoader(response, a, encodeType);
                                }
                            }
                        }
                        catch (err) {
