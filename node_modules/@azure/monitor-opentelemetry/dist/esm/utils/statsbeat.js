...
import { AZURE_MONITOR_STATSBEAT_FEATURES, StatsbeatFeature, StatsbeatFeaturesMap, StatsbeatInstrumentation, } from "../types.js";
import { Logger as InternalLogger } from "../shared/logging/index.js";
let instance;
class StatsbeatConfiguration {
    // Initial Statsbeat options
    initializedByShim = false;
    currentStatsbeatInstrumentations = {};
    currentStatsbeatFeatures = {};
    constructor() {
    ...
    setStatsbeatFeatures = (statsbeatInstrumentations, statsbeatFeatures) => {
        let statsbeatEnv;
        try {
        ...
        statsbeatInstrumentations = {
            ...
            dataloader: statsbeatEnv.instrumentation & StatsbeatInstrumentation.DATALOADER ? true : false,
            fs: statsbeatEnv.instrumentation & StatsbeatInstrumentation.FS ? true : false,
            lruMemoizer: statsbeatEnv.instrumentation & StatsbeatInstrumentation.LRU_MEMOIZER ? true : false,
            mongoose: statsbeatEnv.instrumentation & StatsbeatInstrumentation.MONGOOSE ? true : false,
            runtimeNode: statsbeatEnv.instrumentation & StatsbeatInstrumentation.RUNTIME_NODE ? true : false,
            ...
            genericPool: statsbeatEnv.instrumentation & StatsbeatInstrumentation.GENERIC_POOL ? true : false,
            ...
            nestjsCore: statsbeatEnv.instrumentation & StatsbeatInstrumentation.NESTJS_CORE ? true : false,
