...
import { AZURE_MONITOR_OPENTELEMETRY_VERSION, APPLICATIONINSIGHTS_SDKSTATS_DISABLED, } from "./types.js";
...
function sendAttachWarning() {
    if (process.env[AZURE_MONITOR_AUTO_ATTACH] === "true" && !isFunctionApp()) {
        ...
        const message = "Distro detected that automatic instrumentation may have occurred. Only use autoinstrumentation if you " +
